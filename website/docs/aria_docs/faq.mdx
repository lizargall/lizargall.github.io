...
:::info Writing Sample
This page is an archive of technical writing I did for Project Aria. For the most up to date documentation go to [Project Aria Docs](https://facebookresearch.github.io/projectaria_tools/docs/intro). Some of the links will be broken, as I did not bring across the whole site.
:::
